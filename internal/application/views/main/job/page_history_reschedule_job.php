    ...
    <table class="w-full text-sm">
        ...
        <tbody>
            ...
            <tr class="border-b border-gray-100 hover:bg-gray-50">
                ...
                <td class="px-4 py-3 whitespace-nowrap"><?= return_date_format_with_time($val['CurrentDateJob']) ?></td>
                <td class="px-4 py-3 whitespace-nowrap"><?= return_date_format_with_time($val['RescheduledDateJob'])?></td>
